...
class WebsiteFeatureExtractor:
    def __init__(self, url):
        ...
        self.url_num_emails = len(url_email_addresses)  # TODO: Currently not in use but we could use it later
        ...
        # TODO: we could also test for the file extension
        ...
        self.params_tld_present = None;  # TODO: find out if there is a tld in the param_string variable (hard)
        ...
        self.asn_ip = self.dom_record['asn'] if 'asn' in self.dom_record.keys() else None
        ...
        self.dom_expiration_date = self.whois_record.expiration_date
